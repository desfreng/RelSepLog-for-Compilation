...
Rather than requiring syntactic equality between terminal values,
it instantiates the predicate $\textsf{both\_final}$
defined in \cref{eq:both-final}
with a general postcondition $\Phi$
relating return values and concluding memory states:
\begin{equation*}
  \Phi :
  \val_t \to
  \val_s \to
