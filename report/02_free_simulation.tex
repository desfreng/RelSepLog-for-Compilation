...
Instead,
the user is free to select any new index,
smaller or larger.
...
with respect to the skewed behavioral refinement:
...
The last implication \ding{174} is the most intricate:
