...
hypothesis $H$ is assumed in the context to establish $\text{Goal}''$.
...
\begin{equation*}
  \esim{t}{\prec i}{s}{\Phi} \coloneqq \exists i', i' \prec i \land \esim{t}{i'}{s}{\Phi}
\end{equation*}
