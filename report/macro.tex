...
% ------------------------------------------------------------------------------
\newcommand{\lsim}[3]{#1 \sim_{l} #2 \; \{#3\}}
\newcommand{\esim}[4]{#1 \sim_{e}^{#2} #3 \; \{#4\}}
\newcommand{\isim}[3]{#1 \lesssim #2 \; \{#3\}}
\newcommand{\fsim}[5]{#1 \leftindex[I]_{#2}\lesssim_{#3} #4 \; \{#5\}}
\newcommand{\bfinalf}[1]{\textsf{both\_final}_{#1}}
\newcommand{\bfinal}[3]{\bfinalf{#1}\left(#2, #3\right)}
...
\newcommand{\samerf}[1]{\textsf{same\_res}_{#1}}
\newcommand{\sameargs}[3]{\sameargsf{#1}\left(#2, #3\right)}
\newcommand{\samer}[3]{\samerf{#1}\left(#2, #3\right)}
