...
and instantiated it with the Register Transfer Language,
...
For our setting these advanced
...
express ownership over the memory footprints of both programs,
...
\begin{figure}[htb]
  ...
  \begin{tabular}{lll}
    ...
    & $\begin{aligned}[t]
      ...
      & m_t = m_t^P \uplus m_t^Q \land m_s = m_s^P \uplus m_s^Q \land {} \\
      & P(m_t^P, m_s^P) \land Q(m_t^Q, m_s^Q)
      \end{aligned}$
...
This strict resource forbid any memory leak.
...
breaking its monotonicity and invalidating the value similarity of existing pointers.
...
\begin{itemize}
  ...
  \item \textbf{Extension:}
        ...
        provided their value are related by $\sameval{I}{}{}$.
\end{itemize}
...
and $Q$ is a postcondition refering to the returned values.
...
The definition of the Hoare quadruple is enclosed guarded by a persistent modality $\boxm$
to guaranty that the specification holds independently of heap ownership.
As a consequence,
