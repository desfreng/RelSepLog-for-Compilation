...
in simulations relations and separation logic
...
of two program transformations.
...
Future effort will test the limit of our framework when translating
...
We plan to add it to work toward a language semantics with concurrent execution features.
Additionally,
